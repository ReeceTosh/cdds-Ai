...
public class DebugAStarVisual : MonoBehaviour
{
    public static DebugAStarVisual Instance { get; private set; }
        ...
        for (int x = 0; x < grid.GetWidth(); x++)
        {
            for (int y = 0; y < grid.GetHeight(); y++)
            {
                ...
                gridSnapshotAction.AddAction(() => {
                    ...
                    Color backgroundColor = UtilityClass.GetColorFromString("636363");
                    ...
                    if (isInOpenList)
                    {
                        backgroundColor = UtilityClass.GetColorFromString("009AFF");
                    }
                    if (isCurrent)
                    {
        ...
        for (int x = 0; x < grid.GetWidth(); x++)
        {
            for (int y = 0; y < grid.GetHeight(); y++)
            {
                ...
                gridSnapshotAction.AddAction(() => {
                    ...
                    {
                        backgroundColor = UtilityClass.GetColorFromString("636363");
                    }
